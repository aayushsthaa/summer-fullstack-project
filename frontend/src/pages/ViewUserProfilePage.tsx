  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <button
              onClick={() => navigate(-1)}
              className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-2 text-sm font-semibold"
            >
              <svg
              ...
              {loggedInUserRole === "admin" && (
                <div className="flex justify-end gap-4">
                  <Link
                    ...
                    className="text-center bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 font-bold py-2 px-4 rounded-lg transition-colors"
                  >
                    Edit User
                  </Link>
                  <button
                    onClick={() => setDeleteModal({ isOpen: true })}
                    className="bg-red-100 dark:bg-red-900/50 hover:bg-red-200 dark:hover:bg-red-900 text-red-700 dark:text-red-300 font-bold py-2 px-4 rounded-lg transition-colors"
                  >
                    Delete User
                  </button>
                </div>
      ...
      >
        ...
        action is irreversible and will permanently remove all their data.
      </Modal>
      <Modal
