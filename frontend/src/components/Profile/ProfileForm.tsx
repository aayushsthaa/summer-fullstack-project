...
function ProfileForm({
  ...
  return (
    <>
      <div
        className="fixed inset-0 dark:bg-gray-900 bg-white bg-opacity-50 flex items-center justify-center z-50 p-4 transition-opacity duration-300"
        role="dialog"
        aria-modal="true"
      >
                      ...
                      <div className="space-y-4">
                        ...
                        {errors.skills && (
                          <p className="text-red-500 text-xs mt-1">
                            Please ensure all skill names are filled out.
                          </p>
                        )}
                      </div>

                      <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <h4 className="text-md font-medium text-gray-800 dark:text-gray-300 mb-2">
                          Add a new skill
                        </h4>
            ...
            <div className="flex-shrink-0 flex justify-between gap-4 p-6 sm:p-8 border-t border-gray-200 dark:border-gray-700">
              <div>
                {currentStep > 1 && (
                  <button
                    type="button"
                    onClick={prevStep}
                    className="py-2 px-6 rounded-md text-sm font-semibold transition-colors duration-300 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-200"
                  >
                    Previous
                  </button>
                )}
              ...
              <div className="flex items-center gap-4">
                <button
                  type="button"
                  onClick={onClose}
                  className="py-2 px-6 rounded-md text-sm font-semibold transition-colors duration-300 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
                >
                  Cancel
                </button>
                {currentStep < totalSteps && (
                  <button
                    type="button"
                    onClick={nextStep}
                    className="text-white py-2 px-6 rounded-md bg-blue-600 hover:bg-blue-700 transition-colors text-sm font-semibold"
                  >
                    Next
                  </button>
                )}
