...
function ProfilePage() {
  ...
  if (!profileData) return <div className="text-center mt-10 p-4 dark:text-gray-300">Could not load profile data.</div>;
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-6">
                ...
                {stats ? (
                    ...
                    <p className="italic text-gray-500 dark:text-gray-400 text-sm">No stats available.</p>
                )}
            </div>
